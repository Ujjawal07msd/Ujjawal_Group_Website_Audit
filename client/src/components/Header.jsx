      ...
      <header className="glass-panel sticky top-3 z-40 mx-auto max-w-7xl px-5 py-3.5 my-3 flex flex-wrap items-center justify-between gap-4 border border-slate-800/90 shadow-2xl bg-slate-950/90 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            aria-label="Visit Ujjawal Sharma's GitHub Profile"
          ...
          >
            <svg className="h-4 w-4 fill-current text-slate-300 hover:text-white" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* LinkedIn Profile Link (ujjawalsharma0804) */}
          <a
            href="https://www.linkedin.com/in/ujjawalsharma0804/"
            target="_blank"
            rel="noopener noreferrer"
            title="Visit Ujjawal Sharma's LinkedIn Profile"
            aria-label="Visit Ujjawal Sharma's LinkedIn Profile"
            className="p-2 text-[#0a66c2] hover:text-white bg-slate-900 border border-slate-800 hover:border-[#0a66c2] rounded-xl transition-all flex items-center justify-center shadow-sm"
          >
          ...
          {/* Product Roadmap Modal Button */}
          <button
            onClick={onOpenRoadmap}
            aria-label="Open Product Roadmap Modal"
            className="px-3 py-1.5 text-xs font-semibold bg-slate-900 border border-slate-800 hover:border-[#00d294] text-slate-300 hover:text-white rounded-xl flex items-center gap-1.5 transition-all"
          >
