...
export function JuspayHeroOrbit({ onOpenVideo, onStartAuditScroll }) {
  ...
  return (
    <section className="relative my-8 overflow-hidden rounded-3xl bg-[#060913] border border-slate-800/80 p-6 sm:p-12 text-white shadow-2xl">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <button
              ...
              className="px-7 py-3.5 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-extrabold text-xs sm:text-sm rounded-full shadow-2xl shadow-blue-500/30 flex items-center gap-2.5 border border-blue-400/40 hover:scale-105 transition-all group"
            >
            ...
            >
              <div className="p-1 rounded-full bg-blue-600/30 text-blue-400">
        ...
        <div className="lg:col-span-5 flex items-center justify-center">
          <div className="relative w-[300px] h-[300px] sm:w-[340px] sm:h-[340px] flex items-center justify-center">
            ...
            {/* Outer Orbit Ring */}
            <div className="absolute inset-0 rounded-full border border-slate-700/60 animate-orbit pointer-events-none">
              {/* Revolving Node 1: 98.5 Score */}
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-lg bg-slate-900 border border-emerald-500/50 text-[11px] font-mono text-emerald-400 font-bold shadow-lg flex items-center gap-1">
                <Award className="h-3 w-3" />
                <span>98.5 Score</span>
              </div>

              {/* Revolving Node 2: 5-Pass Scrape */}
              <div className="absolute top-1/2 -right-4 -translate-y-1/2 px-2.5 py-1 rounded-lg bg-slate-900 border border-blue-500/50 text-[11px] font-mono text-blue-400 font-bold shadow-lg flex items-center gap-1">
                <Zap className="h-3 w-3" />
                <span>5-Pass Scrape</span>
              </div>

              {/* Revolving Node 3: 0 Penalties */}
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 px-2.5 py-1 rounded-lg bg-slate-900 border border-purple-500/50 text-[11px] font-mono text-purple-400 font-bold shadow-lg flex items-center gap-1">
            ...
            <div className="absolute w-[200px] h-[200px] rounded-full border border-blue-500/30 bg-blue-600/5 blur-[2px]"></div>

            {/* Center Core Node */}
            <div className="relative z-10 flex flex-col items-center justify-center p-6 rounded-full bg-slate-950 border-2 border-blue-500/60 shadow-2xl shadow-blue-500/30 text-center w-[160px] h-[160px]">
              <img
                src={logoPng}
              ...
              />
              <span className="text-[10px] font-mono font-bold text-blue-400 tracking-wider">WAEF v2.0</span>
